...
class ImageHelper extends AppHelper{
	...
	public function resize($image, $width, $height, $options = array(), $quality = 100){
		...
		return $this->Html->image(DS.$this->resizedUrl($image, $width, $height, $quality), $options);
	}
	...
	public function resizedUrl($file, $width, $height, $quality = 100){
		...
		$imageDir = (!isset($this->theme)) ? APP.DS.'webroot'.DS : APP.'View'.DS.'Themed'.DS.$this->theme.DS.'webroot'.DS.'img'.DS;
